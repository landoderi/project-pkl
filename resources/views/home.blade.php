            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <h1 class="display fw-bold mb-3">
                        Nikmati Pengalaman kopi premium dari<br><span style="color:#f4d9a0;">Mas Ironi</span> dari Rumah
                    </h1>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card promo-card bg-warning text-dark border-0 shadow-sm h-100">
                        <div class="card-body d-flex flex-column justify-content-center text-center">
                            <h3 class="fw-bold mb-2"><i class="bi bi-lightning-charge-fill me-2"></i>Flash Sale!</h3>
                ...
                <div class="col-md-6">
                    <div class="card promo-card bg-info text-white border-0 shadow-sm h-100">
                        <div class="card-body d-flex flex-column justify-content-center text-center">
                            <h3 class="fw-bold mb-2"><i class="bi bi-gift-fill me-2"></i>Member Baru?</h3>
